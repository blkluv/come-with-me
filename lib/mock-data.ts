...
export const CHALLENGES: Challenge[] = [
  {
    id: "1",
    brand: "Timeout New York",
    title: "Chelsea Explorer",
    description: "Visit 5 spots in Chelsea this week and earn the Explorer badge",
    reward: "Featured in Timeout + $50 credit",
    progress: 3,
    total: 5,
    color: "#7B2FFF",
    badgeEmoji: "🏆",
  ...
  },
  {
    ...
    description: "Check in at 3 Blue Bottle locations in NYC",
    reward: "Free bag of single origin beans",
    progress: 1,
    total: 3,
    color: "#0ea5e9",
    badgeEmoji: "☕",
  ...
  },
  {
    ...
    title: "Hidden Gems",
    description: "Save 10 places with fewer than 500 saves",
    reward: "2x Membership Rewards points",
    progress: 6,
    total: 10,
    color: "#CAFF33",
    badgeEmoji: "💎",
